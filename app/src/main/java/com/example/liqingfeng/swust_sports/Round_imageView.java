...
public class Round_imageView extends android.support.v7.widget.AppCompatImageView{
    ...
    public Round_imageView(Context context) {
        super(context);
        mContext = context;
    }

    public Round_imageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        setCustomAttributes(attrs);
    }

    public Round_imageView(Context context, AttributeSet attrs, int defStyle) {
